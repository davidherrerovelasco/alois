...
<html lang="en">
    ...
    <body onload="obtenerRecordatorios()">
        ...
        <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
            <a class="navbar-brand text-white" href="../principal/"><i class="fas fa-arrow-left" style="margin-right:10px"></i>Eliminar Recordatorios</a>
    ...
    <script>
        function obtenerRecordatorios(){
                $.ajax({
                    url: "scriptObtenerRecordatoriosEliminar.php",
