...
<body>
        ...
        <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
            <a class="navbar-brand text-white" href="principalView.php"><i class="fas fa-arrow-left" style="margin-right:10px"></i>Recordatorios</a>
        ...
        <div class="container-fluid" style="padding:20px">
            <form action="registrarRecordatorio.php" method="post">
                <div class="form-row">
